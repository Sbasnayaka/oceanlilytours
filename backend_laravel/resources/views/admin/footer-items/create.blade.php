...
<div class="mb-6 flex items-center gap-4">
    ...
    <h2 class="text-2xl font-bold text-gray-800">Add Footer Item</h2>
</div>
    ...
    <form action="{{ route('footer-items.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-6 mb-8">
            <div>
                ...
                <input type="text" name="section" value="{{ old('section') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="e.g. Quick Links, Contact, Support">
            </div>

            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Label / Key Name <span class="text-red-500">*</span></label>
                <input type="text" name="key_name" value="{{ old('key_name') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="e.g. Terms of Service, Phone Number">
            </div>

            <div>
                <label class="block text-sm font-bold text-gray-700 mb-1">Value / URL <span class="text-red-500">*</span></label>
                <textarea name="value" rows="2" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="e.g. /terms.html, +94 71 123 4567"></textarea>
            </div>
        ...
        <div class="pt-6 border-t border-gray-100 flex justify-end">
            <button type="submit" class="px-8 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 shadow-md transition-all">
                <i class="fas fa-save mr-2"></i> Create Footer Item
            </button>
        </div>
    </form>
</div>
